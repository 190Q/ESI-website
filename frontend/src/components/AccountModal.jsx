    ...
    <div className="modal-backdrop" id="accountModalBackdrop">
      <div className="modal account-modal">
        ...
        <div className="account-modal-layout">
          <aside className="account-modal-deco" id="accountModalDeco">
            <div className="account-medals-row" id="accountModalMedals" />
            <div className="account-badges-col" id="accountModalBadges" />
          </aside>
