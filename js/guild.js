  ...
  function renderGuild(data) {
    ...
    document.getElementById('guildOwedCards').innerHTML = `
      <div class="owed-card owed-card-clickable" id="owedAspectsCard">
        <div class="owed-icon"><img src="aspect_icon.avif" alt="aspect" style="width:32px;height:32px;image-rendering:pixelated"></div>
      ...
      <div class="owed-card">
        <div class="owed-icon"><img src="point_icon.png" alt="point" style="width:32px;height:32px;image-rendering:pixelated"></div>
      ...
      <div class="owed-card owed-card-clickable" id="territoriesCard">
        <div class="owed-icon"><img src="territory_icon.png" alt="territory" style="width:32px;height:32px;image-rendering:pixelated"></div>
    ...
    function renderOwedPopup() {
      ...
      popup.innerHTML = `
        <div class="owed-aspects-popup-header">
          <img src="aspect_icon.avif" alt="aspect" style="width:16px;height:16px;image-rendering:pixelated;vertical-align:middle;margin-right:6px">Aspects Owed
    ...
    function renderTerrPopup() {
      ...
      terrPopup.innerHTML = `
        <div class="owed-aspects-popup-header">
          <img src="territory_icon.png" alt="territory" style="width:16px;height:16px;image-rendering:pixelated;vertical-align:middle;margin-right:6px">
          Territories
